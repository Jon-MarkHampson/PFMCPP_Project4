...
FloatType& FloatType::multiply( float valueToMultiply )
{
...
DoubleType& DoubleType::multiply( double valueToMultiply )
{
    *value *= valueToMultiply;
    return *this;
}
...
IntType& IntType::multiply( int valueToMultiply)
{
    *value *= valueToMultiply;
    return *this;
}
IntType& IntType::divide( int valueOfDenom)
{
    if (valueOfDenom == 0)
    {
